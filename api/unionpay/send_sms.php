...
$params = array(
		...
		//'subMerAbbr'=> '',//二级商户简称--C
		//商户端生成
		'orderId'=> gen_order_id(),//商户订单号--M
		//商户发送交易时间
		'txnTime'=> gen_order_time(),//订单发送时间--M		//txnTime=20150723235200
		...
		//'customerInfo'=> customerInfo_sms('6216261000000000018', '01', '341126197709218366', '全渠道', '13552535506', '123456', '', ''),//银行卡验证信息及身份信息--C
		'customerInfo'=> customerInfo_sms($card_info['acc_no'], $card_info['certif_tp'], $card_info['certif_id'], iconv( "UTF-8", "gb2312" , $card_info['customer_name']), $card_info['phone_no'], $card_info['pin'], $card_info['cvn2'], $card_info['expired']),
		//'customerInfo'=> customerInfo(),//银行卡验证信息及身份信息--C
		//'customerInfo'=> customerInfo_sms($card_info['acc_no'], $card_info['certif_tp'], $card_info['certif_id'], '全渠道', $card_info['phone_no'], $card_info['pin'], $card_info['cvn2'], $card_info['expired']),
